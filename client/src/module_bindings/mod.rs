...
pub use vector_2_table::*;
pub use vector_2_type::Vector2;
...
pub struct DbUpdate {
    ...
    vector_2: __sdk::TableUpdate<Vector2>,
}
    ...
    fn try_from(raw: __ws::DatabaseUpdate<__ws::BsatnFormat>) -> Result<Self, Self::Error> {
        ...
        for table_update in raw.tables {
            match &table_update.table_name[..] {
                ...
                "vector2" => db_update.vector_2 = vector_2_table::parse_table_update(table_update)?,
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.client = cache
            ...
            .with_updates_by_pk(|row| &row.client_id);
        diff.vector_2 = cache.apply_diff_to_table::<Vector2>("vector2", &self.vector_2);
...
pub struct AppliedDiff<'r> {
    ...
    vector_2: __sdk::TableAppliedDiff<'r, Vector2>,
}
...
impl<'r> __sdk::AppliedDiff<'r> for AppliedDiff<'r> {
    fn invoke_row_callbacks(
        ...
        callbacks.invoke_table_row_callbacks::<Vector2>("vector2", &self.vector_2, event);
    }
}
...
impl __sdk::SpacetimeModule for RemoteModule {
    ...
    fn register_tables(client_cache: &mut __sdk::ClientCache<Self>) {
        ...
        vector_2_table::register_table(client_cache);
    }
}
